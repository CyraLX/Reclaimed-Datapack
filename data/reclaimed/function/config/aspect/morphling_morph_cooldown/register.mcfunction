...
## From V2 to V3
execute if score #reclaimed reclaimed.config.morphling.morph_cooldown = #reclaimed reclaimed.config.morphling.morph_cooldown run scoreboard players operation #reclaimed reclaimed.config.aspect.morphling_morph_cooldown = #reclaimed reclaimed.config.morphling.morph_cooldown
