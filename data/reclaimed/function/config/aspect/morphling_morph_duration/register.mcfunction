...
#                           Defaults to [""]
#
data modify storage aspectlib:dummy config set value {namespace:"reclaimed",type:"aspect",name:"morphling_morph_duration",dialog_type:2,dialog_data:{start:0,end:100,step:2,accepts_namespace:"aspects",accepts_name:".above_equal",accepts_with:["0"]}}
