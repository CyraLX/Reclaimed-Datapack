...
# (For example 10 will be interpreted as 5 seconds; Values 0 and less are treated as instant)
# Default: 10
...
#                           Defaults to [""]
#
data modify storage aspectlib:cache temp.config set value {namespace:"reclaimed",type:"aspect",name:"morphling_morph_duration",dialog_type:2,dialog_data:{start:0,end:100,step:2,accepts_namespace:"aspects",accepts_name:".above_equal",accepts_with:["0"]}}
# Define Default value
scoreboard players set #aspectlib aspectlib.temp 10

# Convert legacy scoreboard
## From V2 to V3
execute if score #reclaimed reclaimed.config.morphling.morph_duration = #reclaimed reclaimed.config.morphling.morph_duration run scoreboard players operation #reclaimed reclaimed.config.aspect.morphling_morph_duration = #reclaimed reclaimed.config.morphling.morph_duration
execute if score #reclaimed reclaimed.config.morphling.morph_duration = #reclaimed reclaimed.config.morphling.morph_duration run scoreboard objectives remove reclaimed.config.morphling.morph_duration
