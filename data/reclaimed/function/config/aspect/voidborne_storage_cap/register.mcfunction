...
scoreboard players set #aspectlib aspectlib.temp 5

# Convert legacy scoreboard
## From V2 to V3
execute if score #reclaimed reclaimed.config.voidborne.storage_cap = #reclaimed reclaimed.config.voidborne.storage_cap run scoreboard players operation #reclaimed reclaimed.config.aspect.voidborne_storage_cap = #reclaimed reclaimed.config.voidborne.storage_cap
