...
scoreboard players set #reclaimed reclaimed.pack_format 6
# Define dependencies and supported min and max pack formats
scoreboard players set #reclaimed aspects.pack_format.dependency.min 9
scoreboard players set #reclaimed aspects.pack_format.dependency.max 9
