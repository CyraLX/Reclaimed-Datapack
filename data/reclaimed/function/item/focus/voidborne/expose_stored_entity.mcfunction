# Get NBT
$data modify storage aspectlib:dummy stored_entity set from storage aspectlib:player_$(id) aspects.aspect_data."reclaimed:voidborne".stored_entity_array[$(index)]
