...
data modify storage aspects:registry aspect."reclaimed:voidborne" set value {id: 1668057, namespace: "reclaimed", name: "voidborne", color: "#6902a5", shadow_color: -15400927, sound: "minecraft:block.ender_chest.open"}
