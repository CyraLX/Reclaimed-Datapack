...
data modify storage aspectlib:registry aspect append value {id: 1668057, namespace: "reclaimed", name: "voidborne", color: "#6902a5", shadow_color: -15400927, sound: "minecraft:block.ender_chest.open", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspectlib:registry aspect[{namespace: "reclaimed", name: "voidborne"}]
