...
data modify storage aspectlib:registry aspect append value {id: 1668037, namespace: "reclaimed", name: "pebblemite", color: "#d3d3d3", shadow_color: -13355980, sound: "minecraft:entity.silverfish.ambient", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspectlib:registry aspect[{namespace: "reclaimed", name: "pebblemite"}]
