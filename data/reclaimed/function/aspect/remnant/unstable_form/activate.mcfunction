...
execute store result storage aspectlib:cache temp.max_y int 1 run scoreboard players get @s reclaimed.remnant.unstable_form.max_y
function reclaimed:aspect/remnant/unstable_form/teleport_randomly with storage aspectlib:cache temp
