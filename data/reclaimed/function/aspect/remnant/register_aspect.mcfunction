...
data modify storage aspectlib:registry aspect append value {id: 1668047, namespace: "reclaimed", name: "remnant", color: "#026b85", shadow_color: -16773100, sound: "minecraft:entity.allay.ambient_without_item", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspectlib:registry aspect[{namespace: "reclaimed", name: "remnant"}]
