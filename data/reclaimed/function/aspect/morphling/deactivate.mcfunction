...
function reclaimed:aspect/morphling/form/bossbar/destroy with storage aspectlib:cache temp
...
function aspects:aspect/generic/deactivate with storage aspectlib:registry aspect[{namespace: "reclaimed", name: "morphling"}]
