...
execute if score #reclaimed reclaimed.config.aspect.morphling_morph_cooldown >= #reclaimed reclaimed.morphling.form.switch_grace run scoreboard players operation @s reclaimed.morphling.form.switch_grace = #reclaimed reclaimed.morphling.form.switch_grace
## If grace period is bigger then cooldown, use cooldown value instead
execute unless score #reclaimed reclaimed.config.aspect.morphling_morph_cooldown >= #reclaimed reclaimed.morphling.form.switch_grace run scoreboard players operation @s reclaimed.morphling.form.switch_grace = #reclaimed reclaimed.config.aspect.morphling_morph_cooldown
