...
$data modify storage aspectlib:dummy form set from storage aspects:registry aspect[{namespace: "reclaimed", name: "morphling"}].data.form.$(form)
...
execute store result storage aspectlib:dummy form_time_max int 1 run scoreboard players get #reclaimed reclaimed.config.aspect.morphling_morph_duration
