...
execute unless score #reclaimed reclaimed.config.aspect.morphling_morph_duration matches 1.. run return run function reclaimed:aspect/morphling/form/fire/activate with storage aspectlib:cache temp
...
data modify storage aspectlib:cache temp.form set value 2
