...
data modify storage aspectlib:registry aspect append value {id: 1668077, namespace: "reclaimed", name: "morphling", color: "#0089a1", shadow_color: -12844981, sound: "minecraft:entity.generic.splash", prevent_random: false}

# Generic REGISTER_ASPECT logic
function aspects:aspect/generic/register_aspect with storage aspectlib:registry aspect[{namespace: "reclaimed", name: "morphling"}]
